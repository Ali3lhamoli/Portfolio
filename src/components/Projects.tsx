  ...
  const projects = [
    {
      ...
      description:
        "Contributed as a Backend Developer in a large-scale delivery system consisting of multiple dashboards and mobile applications.",
      highlights: [
    ...
    },
    {
      ...
      tech: ["PHP", "Laravel", "MySQL", "REST APIs", "Blade"],
      description:
        "Worked as a Laravel Backend and Full Stack Developer on a job platform specialized for delivery workers.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Designed and developed an E-commerce backend system using Laravel with an API-first architecture.",
      highlights: [
    ...
    },
    {
      ...
      tech: ["PHP", "Laravel", "MySQL", "REST APIs", "Blade"],
      description:
        "Developed a social networking platform allowing users to register, create posts, interact through likes and comments.",
      highlights: [
    ...
    },
    {
      ...
      tech: ["PHP", "Laravel", "MySQL", "REST APIs", "Blade"],
      description:
        "Created a web-based system for borrowing and returning books, targeting libraries and educational institutions.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Sharikna is an innovative mobile application designed for efficient data sharing and organization on Android and Web platforms.",
      highlights: [
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              A showcase of my backend development work, featuring scalable
              applications and robust API solutions built with modern
              technologies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-900 rounded-xl p-6 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 transform hover:-translate-y-1"
              >
                  ...
                  <div className="flex space-x-2">
                    {project.hasWebsite && (
                      <a
                        ...
                        className="p-2 bg-gradient-to-r from-cyan-100 to-purple-100 dark:from-cyan-900/30 dark:to-purple-900/30 text-cyan-600 dark:text-cyan-400 rounded-lg hover:brightness-110 transition-all duration-300"
                      >
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-2 py-1 bg-gradient-to-r from-cyan-100 to-purple-100 dark:from-cyan-900/20 dark:to-purple-900/20 text-cyan-800 dark:text-cyan-300 rounded-full text-xs font-medium"
                    >
                      {tech}
                    </span>
                  ))}
          ...
          <div className="text-center mt-12">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-700 dark:to-gray-600 text-white rounded-lg hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              <Github size={20} />
