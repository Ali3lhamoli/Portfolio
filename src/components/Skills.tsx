...
const Skills = () => {
  ...
  const getSkillColorClasses = (color: string) => {
    const colorMap = {
      ...
      emerald:
        "bg-gradient-to-r from-emerald-100 to-emerald-200 dark:from-emerald-800/40 dark:to-emerald-700/40 text-emerald-800 dark:text-emerald-200",
      purple:
        "bg-gradient-to-r from-purple-100 to-purple-200 dark:from-purple-800/40 dark:to-purple-700/40 text-purple-800 dark:text-purple-200",
      orange:
        "bg-gradient-to-r from-orange-100 to-orange-200 dark:from-orange-800/40 dark:to-orange-700/40 text-orange-800 dark:text-orange-200",
      indigo:
        "bg-gradient-to-r from-indigo-100 to-indigo-200 dark:from-indigo-800/40 dark:to-indigo-700/40 text-indigo-800 dark:text-indigo-200",
      yellow:
        "bg-gradient-to-r from-yellow-100 to-yellow-200 dark:from-yellow-800/40 dark:to-yellow-700/40 text-yellow-800 dark:text-yellow-200",
    };
    return (
      colorMap[color as keyof typeof colorMap] || "bg-gray-100 text-gray-800"
    );
  };
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto transition-colors duration-300">
              A comprehensive overview of my technical expertise, covering
              backend development, database management, and modern development
              practices.
            </p>
          </div>
            ...
            {skillCategories.map((category, index) => (
              <div
                ...
                className={`${getColorClasses(
                  category.color
                )} border-2 rounded-xl p-6 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 transform hover:-translate-y-1`}
              >
                ...
                <div className="space-y-3">
                  {category.skills.map((skill, skillIndex) => (
                    <div
                      key={skillIndex}
                      className={`${getSkillColorClasses(
                        category.color
                      )} px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 hover:scale-105 cursor-default shadow-sm hover:shadow-md`}
                    >
                      {skill}
                    </div>
                  ))}
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                        Expert in PHP and Laravel framework for building
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                        Specialized in designing and implementing RESTful APIs
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                        Proficient in MySQL database design, optimization, and
                        management
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                        Committed to writing maintainable, scalable code
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                        Experience working in agile teams using Git, GitHub, and
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                        Skilled in React.js and modern frontend technologies for
